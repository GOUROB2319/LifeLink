const translations = {
    ...
    bn: {
        ...
        "auth.register.back_home": "???? ???? ???",

        "auth.register.hero_title": "???? ???????? ??????? ????? ??????",
        "auth.register.feature1.title": "???-????? ???????",
        "auth.register.feature1.desc": "????? ???????? ?????? ?????? ??????? ????? ????? ????? ????",
        "auth.register.feature2.title": "????????? ????? ???????",
        "auth.register.feature2.desc": "????????? ????? ?????? ????????? ?????-???? ???????????",
        "auth.register.feature3.title": "???????? ?????????",
        "auth.register.feature3.desc": "???? ? ????? ????? ?????? ? ???????? ??????",
        "auth.register.social_proof": "???????? ???? ??????? ??,???+ ????? ???? ??? ????",
